...
const PROJECTS = [
  {
    name: "Osteria Rue",
    type: "Hospitality — Paris, '24",
    metric: "Live site",
    detail: "Reservation-first restaurant experience designed specifically for mobile guests.",
  ...
  {
    name: "Maison Canal",
    type: "Apparel / E-commerce",
    metric: "Shopify Headless",
    detail: "Custom Shopify storefront with editorial product storytelling and fluid cart states.",
  ...
  {
    name: "Atelier Luma",
    type: "Architecture — Geneva",
    metric: "Portfolio",
    detail: "Responsive interface system and structured portfolio mapping for a Swiss practice.",
  ...
  },
  {
    ...
    metric: "Next.js",
    detail: "Calm e-commerce architecture with a simplified checkout flow and headless content framing.",
  ...
  },
  {
    ...
    metric: "Sanity CMS",
    detail: "Digital identity and bespoke component library for an independent design consultancy.",
  ...
  },
  {
    ...
    type: "Gallery Space",
    metric: "Archive",
    detail: "Performative web experience focused on accessibility guidelines and seasonal programming.",
